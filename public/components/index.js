		        ...
		        <div class="row">
		          <div class="col-lg-7">
		            <div class="hero-banner__img">
		              <img class="img-fluid" src="../img/banner/hero-banner.png" alt="landingImage"/>
		            </div>
		          </div>
		          ...
		          <div class="col-lg-5 pt-5">
		            <div class="hero-banner__content">
		              ...
		              <p>Whether its punching in to work or requesting a correction for an accidental punch-out, checking on leave balances or checking the attendance report for the month, FieldSense has it all covered for you. </p>
		    ...
		    <section class="section-margin">
		      <div class="container">
		        <div class="section-intro pb-85px text-center">
		          <h2 class="section-intro__title">Flexible Timesheet Capture</h2>
		          <p class="section-intro__subtitle">It’s fast and easy to record hours spent on any activity, project or task using Replicon’s optimized user interfaces for your phone, tablet or computer. Fully customizable, Replicon time tracking software meets your exact needs, working for all types of employees and any timesheet format.</p>
		        </div>
		        ...
		        <div class="row no-gutters align-items-center">
		          <div class="col-md-5 mb-5 mb-md-0">
		            <div class="about__content">
		              <h2>100% Accurate Time</h2>
		              <p>To ensure data is error-free and is ready for processing, Replicon time tracking software helps to verify, cleanse, analyze, review, and apply the right workflows to your time information, and provides a built-in compliance and rules engine to adhere to key business policies.</p>
		              <a class="button button-light" href="#">Know More</a>
		            </div>
		          </div>
		          <div class="col-md-7">
		            <div class="about__img">
		              <img class="img-fluid" src="../img/home/h.png" alt="">
		            </div>
		          </div>
		        </div>
		      </div>
